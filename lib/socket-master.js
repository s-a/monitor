...
function SocketMaster() {
  ...
  this.transports = {
    mail: {
      ...
      intervalHumanReadable: cronExpressionHumanReadable,
    }
  }
  this.log.info('transports', this.transports)
  this.scheduledMail = schedule.scheduleJob(cronExpression, (async function (cronExpressionHumanReadable) {
